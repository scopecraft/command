...
async function fetchSessionDetails(taskId: string): Promise<SessionInfo & { lastLogLines?: string[] }> {
...
export function AutonomousMonitor() {
  ...
  const { data: sessionDetails } = useQuery({
    ...
    queryFn: () => selectedSession ? fetchSessionDetails(selectedSession.taskId) : Promise.resolve(null),
