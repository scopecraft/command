...
# Another Simple Task`;
  ...
  describe('Basic Functionality', () => {
    ...
    it('should switch projects with --root-dir', () => {
      const result1 = execSync(`bun run ./src/cli/cli.ts task list --root-dir ${project1Dir}`, {
        encoding: 'utf8',
        cwd: process.cwd(),
      });
      ...
      const result2 = execSync(`bun run ./src/cli/cli.ts task list --root-dir ${project2Dir}`, {
        encoding: 'utf8',
        cwd: process.cwd(),
      });
  ...
  describe('MCP Server', () => {
    it('should accept --root-dir in MCP server', () => {
      const result = execSync(`bun run ./src/mcp/cli.ts --help`, {
        encoding: 'utf8',
        cwd: process.cwd(),
      });
    ...
    it('should accept --root-dir in STDIO server', () => {
      const result = execSync(`bun run ./src/mcp/stdio-cli.ts --help`, {
        encoding: 'utf8',
        cwd: process.cwd(),
      });
