...
import {
  ...
  parseTasksList,
} from '../../../src/mcp/handlers/shared/options-builders.js';
...
`;
  ...
  describe('buildTaskUpdateOptions sanitization', () => {
    test('sanitizes all section content', () => {
      ...
      expect(result.sections?.tasks).toBe(
        '### Task List\n\n- [ ] Do something\n- [ ] Do another thing'
      );
...
All tests pass successfully.`;
      ...
      const _sanitizedInstruction = sanitizeSectionContent(problematicInstruction);
