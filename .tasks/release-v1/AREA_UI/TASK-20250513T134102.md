...
* - [x] **Multi-phase features/areas support**:
  ...
  * - [ ] Phase selector for switching between entity instances
...
- **2025-05-16**: Remaining work for future tasks:
  - Implement phase selector in Feature/Area detail views
  - Enhance navigation to maintain phase context when viewing entities
  - Add phase detail view that groups features and areas within a phase
