...
export const Starting: Story = {
  render: () => {
    return (
      <div className="space-y-4">
        <p className="text-sm text-muted-foreground">Click the button to see the starting state</p>
        <ClaudeAgentButton
    ...
    return (
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          {!activeSession && !startingSession && <ClaudeAgentButton onClick={handleStart} />}

          {startingSession && <ClaudeAgentButton taskId="demo" onClick={() => {}} />}

          {activeSession && !startingSession && <ClaudeAgentButton taskId="demo-active" />}
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              <button
                className="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-transform bg-[var(--atlas-navy)] text-[var(--cream)] shadow-xs hover:bg-[var(--atlas-navy)]/90 hover:translate-y-[-2px] h-9 px-4 py-2 uppercase group"
                disabled
              >
                Starting...
              </button>
            ...
            <div className="flex items-center gap-4">
              <button
                className="inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80 h-9 px-4 py-2 uppercase"
                disabled
              >
